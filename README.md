...
| 🗂️ **Classify** | One canonical type per claim; conflicts settled by evidence, not file age |
| 💾 **Compound** | Durable Solutions and Lessons instead of more documents |
| 🗑️ **Clean** | Deletes obsolete knowledge regardless of origin |
...
7 tests cover installer targets, the no-double-load rule, and a guardrail keeping the 8 skills, their manifest, and both agent files in sync.
